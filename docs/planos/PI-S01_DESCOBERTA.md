...
| T-03 `max_seq_length` do encoder | **128 no Hub** (`sentence_bert_config.json`); carga local dos pesos `[VAL]` | `docs/00_INVENTARIO_PROJETO.md` §7.1 |
...
- [x] T-03: `max_seq_length=128` no config oficial do Hub; encoder com pesos locais não carregou (`OSError`); sem rechunking
